...
func run() error {
	...
	fixture, err := acceleratoracceptance.LoadSharedFixture(os.Getenv("ACCELERATOR_ACCEPTANCE_SHARED_FIXTURE"))
	if err != nil || fixture.ArtifactRoot != os.Getenv("ACCELERATOR_ACCEPTANCE_ARTIFACT_ROOT") || fixture.AcceptanceImageDigest != os.Getenv("ACCELERATOR_IMAGE_DIGEST") || fixture.ExecutionArchitecture != os.Getenv("KUBIKLES_ACCELERATOR_E2E_EXECUTION_ARCHITECTURE") || strconv.Itoa(fixture.ReconnectGraceSeconds) != os.Getenv("KUBIKLES_ACCELERATOR_E2E_RECONNECT_GRACE_SECONDS") {
		return fmt.Errorf("fixture")
	}
	...
	environment := []string{
		...
		"KUBIKLES_ACCELERATOR_E2E_EXECUTION_ARCHITECTURE=" + os.Getenv("KUBIKLES_ACCELERATOR_E2E_EXECUTION_ARCHITECTURE"),
		...
		"ACCELERATOR_ACCEPTANCE_SHARED_FIXTURE=" + os.Getenv("ACCELERATOR_ACCEPTANCE_SHARED_FIXTURE"),
