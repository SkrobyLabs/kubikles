...
func TestAcceptanceContractExactCaseSet(t *testing.T) {
	...
	expected := []expectedCase{
		...
		{"A60A-015-INTEGRATED-ROUTING", "53dfebec,d0eb9876,d4f712fd", OwnerMake, "test-accelerator-integrated-routing-kind", "routing.direct,routing.enabled-lifetime,routing.operations,routing.source"},
