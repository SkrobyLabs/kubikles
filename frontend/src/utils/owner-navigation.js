 ...
 *
 * @param {object} owner - Owner reference or involved object with apiVersion, kind, uid
 * @param {Array} crds - List of CRDs from K8sContext for custom resource lookup
 * @returns {string|null} View ID for navigation, or null if not navigable
 *
 * @example
 ...
 */
export function getOwnerViewId(owner, crds = []) {
