...
vi.mock('./ContextEditor', () => ({ default: ({ contextName, initialTab, onOpenAcceleratorSettings }: any) => <div data-testid="context-editor"><span data-testid="context-route">{contextName}:{initialTab}</span><button onClick={onOpenAcceleratorSettings}>Open settings</button></div> }));
