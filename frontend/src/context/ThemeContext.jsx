...
const applyFonts = (uiFontId, monoFontId) => {
    const root = document.documentElement;
...
const saveFontPreferences = (ui, mono) => {
    try {
...
export const ThemeProvider = ({ children }) => {
    ...
    // Font preferences
    const [uiFont, setUiFontState] = useState('inter');
    const [monoFont, setMonoFontState] = useState('jetbrains');
    ...
    useEffect(() => {
        ...
        const handleThemeListChanged = (themeList) => {
            setThemes(themeList);
        };
