...
export default function StatefulSetActionsMenu({ statefulSet, isOpen, onOpenChange, onEditYaml, onShowDependencies, onRestart, onDelete, onViewLogs }) {
    ...
    }, [isOpen, statefulSet.metadata.uid, onOpenChange]);
