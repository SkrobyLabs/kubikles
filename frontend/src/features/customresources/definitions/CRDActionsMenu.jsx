...
export default function CRDActionsMenu({ crd, isOpen, onOpenChange, onEditYaml, onDelete }) {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            if (buttonRef.current && !buttonRef.current.contains(event.target)) {
                const menu = document.getElementById(`crd-menu-${crd.metadata.uid}`);
    ...
    }, [isOpen, crd.metadata.uid, onOpenChange]);
    ...
    const menu = (
        ...
        >
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onDelete(crd)); }}
