...
export default function CSINodeActionsMenu({ csiNode, isOpen, menuPosition, onOpenChange, onEditYaml, onDelete }: any) {
    ...
    const menu = (
        ...
        >
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onEditYaml(csiNode)); }}
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onDelete(csiNode)); }}
