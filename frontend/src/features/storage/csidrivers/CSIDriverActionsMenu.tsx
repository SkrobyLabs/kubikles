...
export default function CSIDriverActionsMenu({ csiDriver, isOpen, menuPosition, onOpenChange, onEditYaml, onDelete }: any) {
    ...
    const menu = (
        ...
        >
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onEditYaml(csiDriver)); }}
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onDelete(csiDriver)); }}
