...
export default function StorageClassActionsMenu({ storageClass, isOpen, menuPosition, onOpenChange, onEditYaml, onDelete }: any) {
    ...
    const menu = (
        ...
        >
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onEditYaml(storageClass)); }}
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onDelete(storageClass)); }}
