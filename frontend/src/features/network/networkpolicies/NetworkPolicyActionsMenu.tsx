...
export default function NetworkPolicyActionsMenu({ networkPolicy, isOpen, menuPosition, onOpenChange, onEditYaml, onShowDependencies, onDelete }: any) {
    ...
    const menu = (
        ...
        >
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onEditYaml(networkPolicy)); }}
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onShowDependencies(networkPolicy)); }}
                className="w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-surface-hover flex items-center gap-2"
            >
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onDelete(networkPolicy)); }}
