...
export default function ValidatingWebhookActionsMenu({ webhook, isOpen, menuPosition, onOpenChange, onEditYaml, onShowDependencies, onDelete }: any) {
    ...
    const menu = (
        ...
        >
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onEditYaml(webhook)); }}
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onShowDependencies(webhook)); }}
                className="w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-surface-hover flex items-center gap-2"
            >
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onDelete(webhook)); }}
