...
export default function EventActionsMenu({ event, isOpen, onOpenChange, onEditYaml, onDelete }) {
    ...
    useEffect(() => {
        const handleClickOutside = (e) => {
            if (buttonRef.current && !buttonRef.current.contains(e.target)) {
                const menu = document.getElementById(`event-menu-${event.metadata.uid}`);
    ...
    }, [isOpen, event.metadata.uid, onOpenChange]);
    ...
    const menu = (
        ...
        >
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onDelete(event)); }}
