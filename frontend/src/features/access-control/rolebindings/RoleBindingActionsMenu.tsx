...
export default function RoleBindingActionsMenu({ roleBinding, isOpen, menuPosition, onOpenChange, onEditYaml, onDelete }: any) {
    ...
    const menu = (
        ...
        >
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onEditYaml(roleBinding)); }}
            ...
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onDelete(roleBinding)); }}
