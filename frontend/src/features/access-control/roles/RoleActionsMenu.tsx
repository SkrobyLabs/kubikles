...
export default function RoleActionsMenu({ role, isOpen, menuPosition, onOpenChange, onEditYaml, onDelete }: any) {
    ...
    const menu = (
        ...
        >
            <button
                onClick={(e) => { e.stopPropagation(); handleAction(() => onEditYaml(role)); }}
